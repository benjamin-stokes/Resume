...
\inlineheadsection
    ...
    \inlineheadsection
        ...
        {\acr{R}, Redshift, \acr{PL/SQL}, My\acr{SQL}, Excel, Tableau}
...
{\bodytext{Smash(ai) is an artificial intelligence solutions provider.
    ...
    \item \textit{\textbf {Overseeing the development and
      ...
      customer engagement.  The client's financial model projected
      a \$22 million increase in five-year discounted revenue with an
      \acr{ROI} of 20:1.

   \item \textit{\textbf {Devising a full-stack validation for a
          performance marketing optimization platform.}}  I designed
      and oversaw the deployment of \acr{AI} quality assurance and
      multilevel data
      validation for a highly complex pre-existing platform.
    ...
    \item \textit{\textbf {Architecting, building, and
      ...
      documented cases of false-positives.  The client will be
      utilizing this framework as a standard benchmark for internal
